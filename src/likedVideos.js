...
export default function Liked(){
  const { like, setLike } = VideoContext();
        ...
        <div className="trial">
          ...
          <ul className={`videoOptions ${openMenu ? "openMenu":""}`}>
            <li onClick={(like.find((items)=> items.id===item.id)) ? 
                ...
                (()=>setLike((items)=> [...items, item]))} className="videoOptionItems"><span>Save</span><img className="videoOptionItemLogo" src="./imageStocks/bookmark-regular.svg" alt="menu"></img></li>
